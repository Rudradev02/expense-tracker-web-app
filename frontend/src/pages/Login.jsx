        ...
        <div className="relative z-10">
          ...
          <div className="mt-16 sm:mt-24 space-y-6 max-w-lg">
            ...
            <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
              Track income, analyze spending distribution, and make smarter financial decisions with a clean SaaS dashboard.
            </p>
            ...
            <div className="pt-6 space-y-3 text-xs sm:text-sm text-slate-300">
              <div className="flex items-center gap-3">
                ...
                <span>Real-time income vs expense breakdowns</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-5 h-5 rounded-full bg-blue-500/20 text-blue-400 flex items-center justify-center text-xs font-bold">✓</span>
                <span>Interactive Recharts category & trend analytics</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="w-5 h-5 rounded-full bg-blue-500/20 text-blue-400 flex items-center justify-center text-xs font-bold">✓</span>
                <span>Secure JWT authentication & cloud database persistence</span>
              </div>
            </div>
          </div>
        </div>
